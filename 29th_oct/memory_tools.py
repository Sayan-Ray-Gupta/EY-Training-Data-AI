...
while True:
    ...
    if "weather" in user_input.lower() and ("in" in user_input.lower() or "for" in user_input.lower()):
        try:
            # Extract city from phrases like "how is the weather in dubai" or "weather for riyadh"
            ...
            for i, word in enumerate(words):
                if word in ["in", "for"] and i + 1 < len(words):
                    ...
                    break
            if not city:
                print("Agent: Please specify a city. Example: how is the weather in Dubai")
                continue
            ...
            print("Agent: Could not get weather info:", e)
            continue
